...
fun CircularProgressIndicator(
    ...
    CircularProgressIndicatorImpl(
        ...
        style = style,
        frameRetriever = { color -> SpinnerProgressIconGenerator.Small.generateSvgFrames(color.toRgba()) },
    )
}
...
fun CircularProgressIndicatorBig(
    ...
    CircularProgressIndicatorImpl(
        ...
        style = style,
        frameRetriever = { color -> SpinnerProgressIconGenerator.Big.generateSvgFrames(color.toRgba()) },
    )
}
