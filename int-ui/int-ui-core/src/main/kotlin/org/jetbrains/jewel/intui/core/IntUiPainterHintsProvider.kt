...
import org.jetbrains.jewel.painter.PainterHintsProvider
import org.jetbrains.jewel.painter.hints.Palette
...
abstract class IntUiPainterHintsProvider(
    ...
    init {
        ...
        for ((key, value) in themeIconPalette) {
            ...
            val resolvedColor = namedColor ?: Color.fromRgba(value) ?: continue
    ...
    private fun resolveKeyColor(key: String, keyPalette: Map<String, String?>, isDark: Boolean): Color? {
        ...
        return Color.fromRgba(keyPalette[resolvedKey] ?: return null)
    }
