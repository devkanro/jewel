...
import org.jetbrains.jewel.intui.window.IntUiDecoratedWindowResourceResolver
...
class IntUiTitleBarIcons(
    ...
    companion object {
        ...
        ): PainterProvider = ResourcePainterProvider(basePath, IntUiDecoratedWindowResourceResolver)
